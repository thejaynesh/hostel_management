...
<section class="services py-5">
    ...
    while ($row = mysqli_fetch_assoc($result)){  
		...
		$built_in = $row['built_in'];
		  ...
		  <br>
				<a href="application_form.php"><h3><?php echo $hostel_name; ?></h3></a>
				<div class="row">
					<div class="col-md-3 col-2">
						<h4><?php echo $built_in; ?></h4>
					</div>
		  ...
		  <div class="col-lg-3 col-sm-6 banner_bottom_right_grid">
						<div class="view view-tenth">
							<div class="agile_text_box">
								...
								<h3> Apply for <?php echo $hostel_name; ?></h3>
								<p><?php echo $hostel_name; ?></p>
							</div>
							<div class="mask">
								<a href="application_form.php?id=<?php echo $hostel_id; ?>"><img src="web_home/images/s<?php echo $hostel_id; ?>.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
<br><br>
